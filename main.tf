...
module "ai_foundry_project" {
  ...
  ai_search_auth_type                  = try(each.value.ai_search_connection.auth_type, "ManagedIdentity")
  ai_search_use_project_identity       = try(each.value.ai_search_connection.use_workspace_managed_identity, null)
  ...
  cosmos_db_auth_type                  = try(each.value.cosmos_db_connection.auth_type, "ManagedIdentity")
  cosmos_db_use_project_identity       = try(each.value.cosmos_db_connection.use_workspace_managed_identity, null)
